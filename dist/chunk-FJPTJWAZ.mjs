...
import { useState as useState2, useCallback as useCallback3, useRef as useRef6 } from "react";
...
import { useState as useState5, useEffect as useEffect6, useRef as useRef8 } from "react";
...
function SearchBar({
  ...
  const client = useHuskelContext();
  const timer = useRef8();
  const wrap = useRef8(null);
  const ignoreNextQueryChange = useRef8(false);
  useEffect6(() => {
...
import { useState as useState6, useEffect as useEffect7, useRef as useRef9 } from "react";
...
function SparkleModal({
  ...
  const chatBottomRef = useRef9(null);
  const chatTextareaRef = useRef9(null);
  useEffect7(() => {
...
import { useState as useState7, useRef as useRef10, useEffect as useEffect8 } from "react";
...
import { useState as useState8, useEffect as useEffect9, useRef as useRef11, useCallback as useCallback5 } from "react";
...
function ChatModal({
  ...
  const msgsContainerRef = useRef11(null);
  useEffect9(() => {
    var _a2;
...
//# sourceMappingURL=chunk-FJPTJWAZ.mjs.map